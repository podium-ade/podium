...
[`../profile`](../profile); the rules a bundle has to pass are in
...
[playbook](../profile/playbooks) is the **environment** it follows it in: the image, the tool
...
[`../profile/README.md`](../profile/README.md#run-podiums-own-bot-yourself). The two travel
