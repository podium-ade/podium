...
const file_podium_agent_v1_agent_proto_rawDesc = "" +
	...
	"\x13DeleteSkillResponse2\xf4\x13\n" +
	"\fAgentService\x12[\n" +
	...
	"\n" +
	"RenameChat\x12\".podium.agent.v1.RenameChatRequest\x1a#.podium.agent.v1.RenameChatResponse\x12d\n" +
...
var file_podium_agent_v1_agent_proto_msgTypes = make([]protoimpl.MessageInfo, 75)
var file_podium_agent_v1_agent_proto_goTypes = []any{
	...
	(*SendChatMessageRequest)(nil),     // 46: podium.agent.v1.SendChatMessageRequest
	(*SendChatMessageResponse)(nil),    // 47: podium.agent.v1.SendChatMessageResponse
	(*StreamChatRequest)(nil),          // 48: podium.agent.v1.StreamChatRequest
	(*AgentProfile)(nil),               // 49: podium.agent.v1.AgentProfile
	(*PlaybookResources)(nil),          // 50: podium.agent.v1.PlaybookResources
	(*PlaybookSecretRef)(nil),          // 51: podium.agent.v1.PlaybookSecretRef
	(*PlaybookRepo)(nil),               // 52: podium.agent.v1.PlaybookRepo
	(*PlaybookDefinition)(nil),         // 53: podium.agent.v1.PlaybookDefinition
	(*GetProfileRequest)(nil),          // 54: podium.agent.v1.GetProfileRequest
	(*GetProfileResponse)(nil),         // 55: podium.agent.v1.GetProfileResponse
	(*UpdateProfileRequest)(nil),       // 56: podium.agent.v1.UpdateProfileRequest
	(*UpdateProfileResponse)(nil),      // 57: podium.agent.v1.UpdateProfileResponse
	(*CreatePlaybookRequest)(nil),      // 58: podium.agent.v1.CreatePlaybookRequest
	(*CreatePlaybookResponse)(nil),     // 59: podium.agent.v1.CreatePlaybookResponse
	(*UpdatePlaybookRequest)(nil),      // 60: podium.agent.v1.UpdatePlaybookRequest
	(*UpdatePlaybookResponse)(nil),     // 61: podium.agent.v1.UpdatePlaybookResponse
	(*DeletePlaybookRequest)(nil),      // 62: podium.agent.v1.DeletePlaybookRequest
	(*DeletePlaybookResponse)(nil),     // 63: podium.agent.v1.DeletePlaybookResponse
	(*AgentSkill)(nil),                 // 64: podium.agent.v1.AgentSkill
	(*ListSkillsRequest)(nil),          // 65: podium.agent.v1.ListSkillsRequest
	(*ListSkillsResponse)(nil),         // 66: podium.agent.v1.ListSkillsResponse
	(*UploadSkillRequest)(nil),         // 67: podium.agent.v1.UploadSkillRequest
	(*UploadSkillResponse)(nil),        // 68: podium.agent.v1.UploadSkillResponse
	(*SetSkillEnabledRequest)(nil),     // 69: podium.agent.v1.SetSkillEnabledRequest
	(*SetSkillEnabledResponse)(nil),    // 70: podium.agent.v1.SetSkillEnabledResponse
	(*DeleteSkillRequest)(nil),         // 71: podium.agent.v1.DeleteSkillRequest
	(*DeleteSkillResponse)(nil),        // 72: podium.agent.v1.DeleteSkillResponse
	nil,                                // 73: podium.agent.v1.Memory.MetadataEntry
	nil,                                // 74: podium.agent.v1.PlaybookDefinition.EnvEntry
	(*timestamppb.Timestamp)(nil),      // 75: google.protobuf.Timestamp
}
var file_podium_agent_v1_agent_proto_depIdxs = []int32{
	75, // 0: podium.agent.v1.Session.created_at:type_name -> google.protobuf.Timestamp
	75, // 1: podium.agent.v1.Session.last_turn_at:type_name -> google.protobuf.Timestamp
	75, // 2: podium.agent.v1.Turn.started_at:type_name -> google.protobuf.Timestamp
	75, // 3: podium.agent.v1.Turn.finished_at:type_name -> google.protobuf.Timestamp
	...
	75, // 8: podium.agent.v1.ProviderSettings.set_at:type_name -> google.protobuf.Timestamp
	75, // 9: podium.agent.v1.ProviderSettings.expires_at:type_name -> google.protobuf.Timestamp
	...
	75, // 13: podium.agent.v1.StartProviderOAuthResponse.expires_at:type_name -> google.protobuf.Timestamp
	...
	73, // 17: podium.agent.v1.Memory.metadata:type_name -> podium.agent.v1.Memory.MetadataEntry
	75, // 18: podium.agent.v1.Memory.created_at:type_name -> google.protobuf.Timestamp
	...
	75, // 22: podium.agent.v1.Chat.created_at:type_name -> google.protobuf.Timestamp
	75, // 23: podium.agent.v1.Chat.last_message_at:type_name -> google.protobuf.Timestamp
	36, // 24: podium.agent.v1.ChatMessage.attachments:type_name -> podium.agent.v1.ChatAttachment
	75, // 25: podium.agent.v1.ChatMessage.ts:type_name -> google.protobuf.Timestamp
	...
	75, // 33: podium.agent.v1.AgentProfile.updated_at:type_name -> google.protobuf.Timestamp
	50, // 34: podium.agent.v1.PlaybookDefinition.resources:type_name -> podium.agent.v1.PlaybookResources
	51, // 35: podium.agent.v1.PlaybookDefinition.secrets:type_name -> podium.agent.v1.PlaybookSecretRef
	52, // 36: podium.agent.v1.PlaybookDefinition.repos:type_name -> podium.agent.v1.PlaybookRepo
	74, // 37: podium.agent.v1.PlaybookDefinition.env:type_name -> podium.agent.v1.PlaybookDefinition.EnvEntry
	75, // 38: podium.agent.v1.PlaybookDefinition.updated_at:type_name -> google.protobuf.Timestamp
	49, // 39: podium.agent.v1.GetProfileResponse.profile:type_name -> podium.agent.v1.AgentProfile
	53, // 40: podium.agent.v1.GetProfileResponse.playbooks:type_name -> podium.agent.v1.PlaybookDefinition
	49, // 41: podium.agent.v1.UpdateProfileResponse.profile:type_name -> podium.agent.v1.AgentProfile
	53, // 42: podium.agent.v1.CreatePlaybookRequest.playbook:type_name -> podium.agent.v1.PlaybookDefinition
	53, // 43: podium.agent.v1.CreatePlaybookResponse.playbook:type_name -> podium.agent.v1.PlaybookDefinition
	53, // 44: podium.agent.v1.UpdatePlaybookRequest.playbook:type_name -> podium.agent.v1.PlaybookDefinition
	53, // 45: podium.agent.v1.UpdatePlaybookResponse.playbook:type_name -> podium.agent.v1.PlaybookDefinition
	75, // 46: podium.agent.v1.AgentSkill.uploaded_at:type_name -> google.protobuf.Timestamp
	64, // 47: podium.agent.v1.ListSkillsResponse.skills:type_name -> podium.agent.v1.AgentSkill
	64, // 48: podium.agent.v1.UploadSkillResponse.skill:type_name -> podium.agent.v1.AgentSkill
	64, // 49: podium.agent.v1.SetSkillEnabledResponse.skill:type_name -> podium.agent.v1.AgentSkill
	...
	54, // 63: podium.agent.v1.AgentService.GetProfile:input_type -> podium.agent.v1.GetProfileRequest
	56, // 64: podium.agent.v1.AgentService.UpdateProfile:input_type -> podium.agent.v1.UpdateProfileRequest
	58, // 65: podium.agent.v1.AgentService.CreatePlaybook:input_type -> podium.agent.v1.CreatePlaybookRequest
	60, // 66: podium.agent.v1.AgentService.UpdatePlaybook:input_type -> podium.agent.v1.UpdatePlaybookRequest
	62, // 67: podium.agent.v1.AgentService.DeletePlaybook:input_type -> podium.agent.v1.DeletePlaybookRequest
	65, // 68: podium.agent.v1.AgentService.ListSkills:input_type -> podium.agent.v1.ListSkillsRequest
	67, // 69: podium.agent.v1.AgentService.UploadSkill:input_type -> podium.agent.v1.UploadSkillRequest
	69, // 70: podium.agent.v1.AgentService.SetSkillEnabled:input_type -> podium.agent.v1.SetSkillEnabledRequest
	71, // 71: podium.agent.v1.AgentService.DeleteSkill:input_type -> podium.agent.v1.DeleteSkillRequest
	...
	46, // 75: podium.agent.v1.AgentService.SendChatMessage:input_type -> podium.agent.v1.SendChatMessageRequest
	48, // 76: podium.agent.v1.AgentService.StreamChat:input_type -> podium.agent.v1.StreamChatRequest
	4,  // 77: podium.agent.v1.AgentService.ListSessions:output_type -> podium.agent.v1.ListSessionsResponse
	6,  // 78: podium.agent.v1.AgentService.GetSession:output_type -> podium.agent.v1.GetSessionResponse
	8,  // 79: podium.agent.v1.AgentService.ListTurns:output_type -> podium.agent.v1.ListTurnsResponse
	11, // 80: podium.agent.v1.AgentService.GetSettings:output_type -> podium.agent.v1.GetSettingsResponse
	13, // 81: podium.agent.v1.AgentService.SetProviderKey:output_type -> podium.agent.v1.SetProviderKeyResponse
	16, // 82: podium.agent.v1.AgentService.ClearProviderKey:output_type -> podium.agent.v1.ClearProviderKeyResponse
	18, // 83: podium.agent.v1.AgentService.StartProviderOAuth:output_type -> podium.agent.v1.StartProviderOAuthResponse
	20, // 84: podium.agent.v1.AgentService.PollProviderOAuth:output_type -> podium.agent.v1.PollProviderOAuthResponse
	24, // 85: podium.agent.v1.AgentService.ListAgents:output_type -> podium.agent.v1.ListAgentsResponse
	27, // 86: podium.agent.v1.AgentService.ListMemories:output_type -> podium.agent.v1.ListMemoriesResponse
	29, // 87: podium.agent.v1.AgentService.SearchMemories:output_type -> podium.agent.v1.SearchMemoriesResponse
	31, // 88: podium.agent.v1.AgentService.DeleteMemory:output_type -> podium.agent.v1.DeleteMemoryResponse
	34, // 89: podium.agent.v1.AgentService.ListPlaybooks:output_type -> podium.agent.v1.ListPlaybooksResponse
	55, // 90: podium.agent.v1.AgentService.GetProfile:output_type -> podium.agent.v1.GetProfileResponse
	57, // 91: podium.agent.v1.AgentService.UpdateProfile:output_type -> podium.agent.v1.UpdateProfileResponse
	59, // 92: podium.agent.v1.AgentService.CreatePlaybook:output_type -> podium.agent.v1.CreatePlaybookResponse
	61, // 93: podium.agent.v1.AgentService.UpdatePlaybook:output_type -> podium.agent.v1.UpdatePlaybookResponse
	63, // 94: podium.agent.v1.AgentService.DeletePlaybook:output_type -> podium.agent.v1.DeletePlaybookResponse
	66, // 95: podium.agent.v1.AgentService.ListSkills:output_type -> podium.agent.v1.ListSkillsResponse
	68, // 96: podium.agent.v1.AgentService.UploadSkill:output_type -> podium.agent.v1.UploadSkillResponse
	70, // 97: podium.agent.v1.AgentService.SetSkillEnabled:output_type -> podium.agent.v1.SetSkillEnabledResponse
	72, // 98: podium.agent.v1.AgentService.DeleteSkill:output_type -> podium.agent.v1.DeleteSkillResponse
	41, // 99: podium.agent.v1.AgentService.CreateChat:output_type -> podium.agent.v1.CreateChatResponse
	45, // 100: podium.agent.v1.AgentService.ListChats:output_type -> podium.agent.v1.ListChatsResponse
	43, // 101: podium.agent.v1.AgentService.RenameChat:output_type -> podium.agent.v1.RenameChatResponse
	47, // 102: podium.agent.v1.AgentService.SendChatMessage:output_type -> podium.agent.v1.SendChatMessageResponse
	39, // 103: podium.agent.v1.AgentService.StreamChat:output_type -> podium.agent.v1.ChatFrame
