...
var file_podium_agent_v1_agent_proto_depIdxs = []int32{
	...
	35, // 29: podium.agent.v1.RenameChatResponse.chat:type_name -> podium.agent.v1.Chat
	...
	77, // 33: podium.agent.v1.AgentProfile.updated_at:type_name -> google.protobuf.Timestamp
	52, // 34: podium.agent.v1.PlaybookDefinition.resources:type_name -> podium.agent.v1.PlaybookResources
	53, // 35: podium.agent.v1.PlaybookDefinition.secrets:type_name -> podium.agent.v1.PlaybookSecretRef
	54, // 36: podium.agent.v1.PlaybookDefinition.repos:type_name -> podium.agent.v1.PlaybookRepo
	76, // 37: podium.agent.v1.PlaybookDefinition.env:type_name -> podium.agent.v1.PlaybookDefinition.EnvEntry
	77, // 38: podium.agent.v1.PlaybookDefinition.updated_at:type_name -> google.protobuf.Timestamp
	51, // 39: podium.agent.v1.GetProfileResponse.profile:type_name -> podium.agent.v1.AgentProfile
	55, // 40: podium.agent.v1.GetProfileResponse.playbooks:type_name -> podium.agent.v1.PlaybookDefinition
	51, // 41: podium.agent.v1.UpdateProfileResponse.profile:type_name -> podium.agent.v1.AgentProfile
	55, // 42: podium.agent.v1.CreatePlaybookRequest.playbook:type_name -> podium.agent.v1.PlaybookDefinition
	55, // 43: podium.agent.v1.CreatePlaybookResponse.playbook:type_name -> podium.agent.v1.PlaybookDefinition
	55, // 44: podium.agent.v1.UpdatePlaybookRequest.playbook:type_name -> podium.agent.v1.PlaybookDefinition
	55, // 45: podium.agent.v1.UpdatePlaybookResponse.playbook:type_name -> podium.agent.v1.PlaybookDefinition
	77, // 46: podium.agent.v1.AgentSkill.uploaded_at:type_name -> google.protobuf.Timestamp
	66, // 47: podium.agent.v1.ListSkillsResponse.skills:type_name -> podium.agent.v1.AgentSkill
	66, // 48: podium.agent.v1.UploadSkillResponse.skill:type_name -> podium.agent.v1.AgentSkill
	66, // 49: podium.agent.v1.SetSkillEnabledResponse.skill:type_name -> podium.agent.v1.AgentSkill
	...
	56, // 63: podium.agent.v1.AgentService.GetProfile:input_type -> podium.agent.v1.GetProfileRequest
	58, // 64: podium.agent.v1.AgentService.UpdateProfile:input_type -> podium.agent.v1.UpdateProfileRequest
	60, // 65: podium.agent.v1.AgentService.CreatePlaybook:input_type -> podium.agent.v1.CreatePlaybookRequest
	62, // 66: podium.agent.v1.AgentService.UpdatePlaybook:input_type -> podium.agent.v1.UpdatePlaybookRequest
	64, // 67: podium.agent.v1.AgentService.DeletePlaybook:input_type -> podium.agent.v1.DeletePlaybookRequest
	67, // 68: podium.agent.v1.AgentService.ListSkills:input_type -> podium.agent.v1.ListSkillsRequest
	69, // 69: podium.agent.v1.AgentService.UploadSkill:input_type -> podium.agent.v1.UploadSkillRequest
	71, // 70: podium.agent.v1.AgentService.SetSkillEnabled:input_type -> podium.agent.v1.SetSkillEnabledRequest
	73, // 71: podium.agent.v1.AgentService.DeleteSkill:input_type -> podium.agent.v1.DeleteSkillRequest
	40, // 72: podium.agent.v1.AgentService.CreateChat:input_type -> podium.agent.v1.CreateChatRequest
	44, // 73: podium.agent.v1.AgentService.ListChats:input_type -> podium.agent.v1.ListChatsRequest
	42, // 74: podium.agent.v1.AgentService.RenameChat:input_type -> podium.agent.v1.RenameChatRequest
	46, // 75: podium.agent.v1.AgentService.DeleteChat:input_type -> podium.agent.v1.DeleteChatRequest
	48, // 76: podium.agent.v1.AgentService.SendChatMessage:input_type -> podium.agent.v1.SendChatMessageRequest
	50, // 77: podium.agent.v1.AgentService.StreamChat:input_type -> podium.agent.v1.StreamChatRequest
	4,  // 78: podium.agent.v1.AgentService.ListSessions:output_type -> podium.agent.v1.ListSessionsResponse
	6,  // 79: podium.agent.v1.AgentService.GetSession:output_type -> podium.agent.v1.GetSessionResponse
	8,  // 80: podium.agent.v1.AgentService.ListTurns:output_type -> podium.agent.v1.ListTurnsResponse
	11, // 81: podium.agent.v1.AgentService.GetSettings:output_type -> podium.agent.v1.GetSettingsResponse
	13, // 82: podium.agent.v1.AgentService.SetProviderKey:output_type -> podium.agent.v1.SetProviderKeyResponse
	16, // 83: podium.agent.v1.AgentService.ClearProviderKey:output_type -> podium.agent.v1.ClearProviderKeyResponse
	18, // 84: podium.agent.v1.AgentService.StartProviderOAuth:output_type -> podium.agent.v1.StartProviderOAuthResponse
	20, // 85: podium.agent.v1.AgentService.PollProviderOAuth:output_type -> podium.agent.v1.PollProviderOAuthResponse
	24, // 86: podium.agent.v1.AgentService.ListAgents:output_type -> podium.agent.v1.ListAgentsResponse
	27, // 87: podium.agent.v1.AgentService.ListMemories:output_type -> podium.agent.v1.ListMemoriesResponse
	29, // 88: podium.agent.v1.AgentService.SearchMemories:output_type -> podium.agent.v1.SearchMemoriesResponse
	31, // 89: podium.agent.v1.AgentService.DeleteMemory:output_type -> podium.agent.v1.DeleteMemoryResponse
	34, // 90: podium.agent.v1.AgentService.ListPlaybooks:output_type -> podium.agent.v1.ListPlaybooksResponse
	57, // 91: podium.agent.v1.AgentService.GetProfile:output_type -> podium.agent.v1.GetProfileResponse
	59, // 92: podium.agent.v1.AgentService.UpdateProfile:output_type -> podium.agent.v1.UpdateProfileResponse
	61, // 93: podium.agent.v1.AgentService.CreatePlaybook:output_type -> podium.agent.v1.CreatePlaybookResponse
	63, // 94: podium.agent.v1.AgentService.UpdatePlaybook:output_type -> podium.agent.v1.UpdatePlaybookResponse
	65, // 95: podium.agent.v1.AgentService.DeletePlaybook:output_type -> podium.agent.v1.DeletePlaybookResponse
	68, // 96: podium.agent.v1.AgentService.ListSkills:output_type -> podium.agent.v1.ListSkillsResponse
	70, // 97: podium.agent.v1.AgentService.UploadSkill:output_type -> podium.agent.v1.UploadSkillResponse
	72, // 98: podium.agent.v1.AgentService.SetSkillEnabled:output_type -> podium.agent.v1.SetSkillEnabledResponse
	74, // 99: podium.agent.v1.AgentService.DeleteSkill:output_type -> podium.agent.v1.DeleteSkillResponse
	41, // 100: podium.agent.v1.AgentService.CreateChat:output_type -> podium.agent.v1.CreateChatResponse
	45, // 101: podium.agent.v1.AgentService.ListChats:output_type -> podium.agent.v1.ListChatsResponse
	43, // 102: podium.agent.v1.AgentService.RenameChat:output_type -> podium.agent.v1.RenameChatResponse
	47, // 103: podium.agent.v1.AgentService.DeleteChat:output_type -> podium.agent.v1.DeleteChatResponse
	49, // 104: podium.agent.v1.AgentService.SendChatMessage:output_type -> podium.agent.v1.SendChatMessageResponse
	39, // 105: podium.agent.v1.AgentService.StreamChat:output_type -> podium.agent.v1.ChatFrame
