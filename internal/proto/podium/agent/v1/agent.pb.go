...
var file_podium_agent_v1_agent_proto_msgTypes = make([]protoimpl.MessageInfo, 109)
var file_podium_agent_v1_agent_proto_goTypes = []any{
	...
	nil,                                   // 107: podium.agent.v1.Memory.MetadataEntry
	nil,                                   // 108: podium.agent.v1.PlaybookDefinition.EnvEntry
	(*timestamppb.Timestamp)(nil),         // 109: google.protobuf.Timestamp
}
var file_podium_agent_v1_agent_proto_depIdxs = []int32{
	109, // 0: podium.agent.v1.Session.created_at:type_name -> google.protobuf.Timestamp
	109, // 1: podium.agent.v1.Session.last_turn_at:type_name -> google.protobuf.Timestamp
	109, // 2: podium.agent.v1.Turn.started_at:type_name -> google.protobuf.Timestamp
	109, // 3: podium.agent.v1.Turn.finished_at:type_name -> google.protobuf.Timestamp
	...
	109, // 8: podium.agent.v1.TaskCost.started_at:type_name -> google.protobuf.Timestamp
	109, // 9: podium.agent.v1.TaskCost.finished_at:type_name -> google.protobuf.Timestamp
	109, // 10: podium.agent.v1.GetUsageRequest.from:type_name -> google.protobuf.Timestamp
	109, // 11: podium.agent.v1.GetUsageRequest.to:type_name -> google.protobuf.Timestamp
	109, // 12: podium.agent.v1.GetUsageRequest.compare_from:type_name -> google.protobuf.Timestamp
	...
	109, // 16: podium.agent.v1.ProviderSettings.set_at:type_name -> google.protobuf.Timestamp
	109, // 17: podium.agent.v1.ProviderSettings.expires_at:type_name -> google.protobuf.Timestamp
	...
	109, // 21: podium.agent.v1.StartProviderOAuthResponse.expires_at:type_name -> google.protobuf.Timestamp
	...
	107, // 25: podium.agent.v1.Memory.metadata:type_name -> podium.agent.v1.Memory.MetadataEntry
	109, // 26: podium.agent.v1.Memory.created_at:type_name -> google.protobuf.Timestamp
	...
	109, // 31: podium.agent.v1.Chat.created_at:type_name -> google.protobuf.Timestamp
	109, // 32: podium.agent.v1.Chat.last_message_at:type_name -> google.protobuf.Timestamp
	42,  // 33: podium.agent.v1.ChatMessage.attachments:type_name -> podium.agent.v1.ChatAttachment
	109, // 34: podium.agent.v1.ChatMessage.ts:type_name -> google.protobuf.Timestamp
	109, // 35: podium.agent.v1.ChatPullRequest.created_at:type_name -> google.protobuf.Timestamp
	...
	109, // 48: podium.agent.v1.AgentProfile.updated_at:type_name -> google.protobuf.Timestamp
	...
	108, // 52: podium.agent.v1.PlaybookDefinition.env:type_name -> podium.agent.v1.PlaybookDefinition.EnvEntry
	109, // 53: podium.agent.v1.PlaybookDefinition.updated_at:type_name -> google.protobuf.Timestamp
	...
	109, // 62: podium.agent.v1.AgentSkill.uploaded_at:type_name -> google.protobuf.Timestamp
	...
	109, // 66: podium.agent.v1.McpServer.token_set_at:type_name -> google.protobuf.Timestamp
	109, // 67: podium.agent.v1.McpServer.updated_at:type_name -> google.protobuf.Timestamp
	109, // 68: podium.agent.v1.McpServer.expires_at:type_name -> google.protobuf.Timestamp
	...
	109, // 76: podium.agent.v1.StartMcpOAuthResponse.expires_at:type_name -> google.protobuf.Timestamp
	90,  // 77: podium.agent.v1.CompleteMcpOAuthResponse.server:type_name -> podium.agent.v1.McpServer
	3,   // 78: podium.agent.v1.AgentService.ListSessions:input_type -> podium.agent.v1.ListSessionsRequest
	5,   // 79: podium.agent.v1.AgentService.GetSession:input_type -> podium.agent.v1.GetSessionRequest
	7,   // 80: podium.agent.v1.AgentService.ListTurns:input_type -> podium.agent.v1.ListTurnsRequest
	12,  // 81: podium.agent.v1.AgentService.GetUsage:input_type -> podium.agent.v1.GetUsageRequest
	14,  // 82: podium.agent.v1.AgentService.GetSettings:input_type -> podium.agent.v1.GetSettingsRequest
	17,  // 83: podium.agent.v1.AgentService.SetProviderKey:input_type -> podium.agent.v1.SetProviderKeyRequest
	20,  // 84: podium.agent.v1.AgentService.ClearProviderKey:input_type -> podium.agent.v1.ClearProviderKeyRequest
	22,  // 85: podium.agent.v1.AgentService.StartProviderOAuth:input_type -> podium.agent.v1.StartProviderOAuthRequest
	24,  // 86: podium.agent.v1.AgentService.PollProviderOAuth:input_type -> podium.agent.v1.PollProviderOAuthRequest
	28,  // 87: podium.agent.v1.AgentService.ListAgents:input_type -> podium.agent.v1.ListAgentsRequest
	31,  // 88: podium.agent.v1.AgentService.ListMemories:input_type -> podium.agent.v1.ListMemoriesRequest
	33,  // 89: podium.agent.v1.AgentService.SearchMemories:input_type -> podium.agent.v1.SearchMemoriesRequest
	35,  // 90: podium.agent.v1.AgentService.DeleteMemory:input_type -> podium.agent.v1.DeleteMemoryRequest
	38,  // 91: podium.agent.v1.AgentService.ListPlaybooks:input_type -> podium.agent.v1.ListPlaybooksRequest
	69,  // 92: podium.agent.v1.AgentService.GetProfile:input_type -> podium.agent.v1.GetProfileRequest
	71,  // 93: podium.agent.v1.AgentService.UpdateProfile:input_type -> podium.agent.v1.UpdateProfileRequest
	73,  // 94: podium.agent.v1.AgentService.ReloadProfileDir:input_type -> podium.agent.v1.ReloadProfileDirRequest
	75,  // 95: podium.agent.v1.AgentService.CreatePlaybook:input_type -> podium.agent.v1.CreatePlaybookRequest
	77,  // 96: podium.agent.v1.AgentService.UpdatePlaybook:input_type -> podium.agent.v1.UpdatePlaybookRequest
	79,  // 97: podium.agent.v1.AgentService.DeletePlaybook:input_type -> podium.agent.v1.DeletePlaybookRequest
	82,  // 98: podium.agent.v1.AgentService.ListSkills:input_type -> podium.agent.v1.ListSkillsRequest
	84,  // 99: podium.agent.v1.AgentService.UploadSkill:input_type -> podium.agent.v1.UploadSkillRequest
	86,  // 100: podium.agent.v1.AgentService.SetSkillEnabled:input_type -> podium.agent.v1.SetSkillEnabledRequest
	88,  // 101: podium.agent.v1.AgentService.DeleteSkill:input_type -> podium.agent.v1.DeleteSkillRequest
	91,  // 102: podium.agent.v1.AgentService.ListMcpServers:input_type -> podium.agent.v1.ListMcpServersRequest
	93,  // 103: podium.agent.v1.AgentService.CreateMcpServer:input_type -> podium.agent.v1.CreateMcpServerRequest
	95,  // 104: podium.agent.v1.AgentService.UpdateMcpServer:input_type -> podium.agent.v1.UpdateMcpServerRequest
	97,  // 105: podium.agent.v1.AgentService.DeleteMcpServer:input_type -> podium.agent.v1.DeleteMcpServerRequest
	99,  // 106: podium.agent.v1.AgentService.SetMcpServerToken:input_type -> podium.agent.v1.SetMcpServerTokenRequest
	101, // 107: podium.agent.v1.AgentService.ClearMcpServerToken:input_type -> podium.agent.v1.ClearMcpServerTokenRequest
	103, // 108: podium.agent.v1.AgentService.StartMcpOAuth:input_type -> podium.agent.v1.StartMcpOAuthRequest
	105, // 109: podium.agent.v1.AgentService.CompleteMcpOAuth:input_type -> podium.agent.v1.CompleteMcpOAuthRequest
	48,  // 110: podium.agent.v1.AgentService.CreateChat:input_type -> podium.agent.v1.CreateChatRequest
	52,  // 111: podium.agent.v1.AgentService.ListChats:input_type -> podium.agent.v1.ListChatsRequest
	50,  // 112: podium.agent.v1.AgentService.RenameChat:input_type -> podium.agent.v1.RenameChatRequest
	54,  // 113: podium.agent.v1.AgentService.DeleteChat:input_type -> podium.agent.v1.DeleteChatRequest
	56,  // 114: podium.agent.v1.AgentService.SendChatMessage:input_type -> podium.agent.v1.SendChatMessageRequest
	58,  // 115: podium.agent.v1.AgentService.StreamChat:input_type -> podium.agent.v1.StreamChatRequest
	59,  // 116: podium.agent.v1.AgentService.AttachChatPullRequest:input_type -> podium.agent.v1.AttachChatPullRequestRequest
	61,  // 117: podium.agent.v1.AgentService.DetachChatPullRequest:input_type -> podium.agent.v1.DetachChatPullRequestRequest
	4,   // 118: podium.agent.v1.AgentService.ListSessions:output_type -> podium.agent.v1.ListSessionsResponse
	6,   // 119: podium.agent.v1.AgentService.GetSession:output_type -> podium.agent.v1.GetSessionResponse
	8,   // 120: podium.agent.v1.AgentService.ListTurns:output_type -> podium.agent.v1.ListTurnsResponse
	13,  // 121: podium.agent.v1.AgentService.GetUsage:output_type -> podium.agent.v1.GetUsageResponse
	16,  // 122: podium.agent.v1.AgentService.GetSettings:output_type -> podium.agent.v1.GetSettingsResponse
	18,  // 123: podium.agent.v1.AgentService.SetProviderKey:output_type -> podium.agent.v1.SetProviderKeyResponse
	21,  // 124: podium.agent.v1.AgentService.ClearProviderKey:output_type -> podium.agent.v1.ClearProviderKeyResponse
	23,  // 125: podium.agent.v1.AgentService.StartProviderOAuth:output_type -> podium.agent.v1.StartProviderOAuthResponse
	25,  // 126: podium.agent.v1.AgentService.PollProviderOAuth:output_type -> podium.agent.v1.PollProviderOAuthResponse
	29,  // 127: podium.agent.v1.AgentService.ListAgents:output_type -> podium.agent.v1.ListAgentsResponse
	32,  // 128: podium.agent.v1.AgentService.ListMemories:output_type -> podium.agent.v1.ListMemoriesResponse
	34,  // 129: podium.agent.v1.AgentService.SearchMemories:output_type -> podium.agent.v1.SearchMemoriesResponse
	36,  // 130: podium.agent.v1.AgentService.DeleteMemory:output_type -> podium.agent.v1.DeleteMemoryResponse
	40,  // 131: podium.agent.v1.AgentService.ListPlaybooks:output_type -> podium.agent.v1.ListPlaybooksResponse
	70,  // 132: podium.agent.v1.AgentService.GetProfile:output_type -> podium.agent.v1.GetProfileResponse
	72,  // 133: podium.agent.v1.AgentService.UpdateProfile:output_type -> podium.agent.v1.UpdateProfileResponse
	74,  // 134: podium.agent.v1.AgentService.ReloadProfileDir:output_type -> podium.agent.v1.ReloadProfileDirResponse
	76,  // 135: podium.agent.v1.AgentService.CreatePlaybook:output_type -> podium.agent.v1.CreatePlaybookResponse
	78,  // 136: podium.agent.v1.AgentService.UpdatePlaybook:output_type -> podium.agent.v1.UpdatePlaybookResponse
	80,  // 137: podium.agent.v1.AgentService.DeletePlaybook:output_type -> podium.agent.v1.DeletePlaybookResponse
	83,  // 138: podium.agent.v1.AgentService.ListSkills:output_type -> podium.agent.v1.ListSkillsResponse
	85,  // 139: podium.agent.v1.AgentService.UploadSkill:output_type -> podium.agent.v1.UploadSkillResponse
	87,  // 140: podium.agent.v1.AgentService.SetSkillEnabled:output_type -> podium.agent.v1.SetSkillEnabledResponse
	89,  // 141: podium.agent.v1.AgentService.DeleteSkill:output_type -> podium.agent.v1.DeleteSkillResponse
	92,  // 142: podium.agent.v1.AgentService.ListMcpServers:output_type -> podium.agent.v1.ListMcpServersResponse
	94,  // 143: podium.agent.v1.AgentService.CreateMcpServer:output_type -> podium.agent.v1.CreateMcpServerResponse
	96,  // 144: podium.agent.v1.AgentService.UpdateMcpServer:output_type -> podium.agent.v1.UpdateMcpServerResponse
	98,  // 145: podium.agent.v1.AgentService.DeleteMcpServer:output_type -> podium.agent.v1.DeleteMcpServerResponse
	100, // 146: podium.agent.v1.AgentService.SetMcpServerToken:output_type -> podium.agent.v1.SetMcpServerTokenResponse
	102, // 147: podium.agent.v1.AgentService.ClearMcpServerToken:output_type -> podium.agent.v1.ClearMcpServerTokenResponse
	104, // 148: podium.agent.v1.AgentService.StartMcpOAuth:output_type -> podium.agent.v1.StartMcpOAuthResponse
	106, // 149: podium.agent.v1.AgentService.CompleteMcpOAuth:output_type -> podium.agent.v1.CompleteMcpOAuthResponse
	49,  // 150: podium.agent.v1.AgentService.CreateChat:output_type -> podium.agent.v1.CreateChatResponse
	53,  // 151: podium.agent.v1.AgentService.ListChats:output_type -> podium.agent.v1.ListChatsResponse
	51,  // 152: podium.agent.v1.AgentService.RenameChat:output_type -> podium.agent.v1.RenameChatResponse
	55,  // 153: podium.agent.v1.AgentService.DeleteChat:output_type -> podium.agent.v1.DeleteChatResponse
	57,  // 154: podium.agent.v1.AgentService.SendChatMessage:output_type -> podium.agent.v1.SendChatMessageResponse
	47,  // 155: podium.agent.v1.AgentService.StreamChat:output_type -> podium.agent.v1.ChatFrame
	60,  // 156: podium.agent.v1.AgentService.AttachChatPullRequest:output_type -> podium.agent.v1.AttachChatPullRequestResponse
	62,  // 157: podium.agent.v1.AgentService.DetachChatPullRequest:output_type -> podium.agent.v1.DetachChatPullRequestResponse
