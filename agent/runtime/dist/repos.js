 ...
 */
export function workspaceOf(brief, cwd = process.cwd()) {
 ...
 */
export const CredentialHelper = `!f() { if test "$1" = get; then echo username=x-access-token; echo "password=$${TokenEnv}"; fi; }; f`;
 ...
 */
export function repoCommands(repo, tokenAvailable, root = WorkspaceDir) {
...
export function cloneRepos(repos, opts = {}) {
