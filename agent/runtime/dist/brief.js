 ...
 */
export function decodeBrief(env) {
    ...
    if (version !== 1) {
        throw new BriefError(`turn brief version is ${JSON.stringify(version) ?? "absent"}; this runtime speaks version 1`);
    }
